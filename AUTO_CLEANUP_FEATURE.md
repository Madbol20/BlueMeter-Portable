...
2. **Automatic Cleanup** (if size exceeds limit)
   - Deletes oldest encounters, keeping most recent N (default: 100)
...
[DatabaseInitializer] ✅ Deleted 1147 old encounters, keeping most recent 100
...
- **Result**:
  - Deletes ~1100+ old/empty encounters
  - Keeps last 100 good encounters
...
- **Result**: Always keeps recent 100 encounters, auto-maintains size
...
[ ] Enable automatic database cleanup
    Max encounters to keep: [100] (10-1000)
