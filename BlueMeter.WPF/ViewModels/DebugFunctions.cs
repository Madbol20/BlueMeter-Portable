...
public partial class DebugFunctions : BaseViewModel, IDisposable
{
    ...
    public void Dispose()
    {
        // MEMORY LEAK FIX: Unsubscribe from PropertyChanged event (line 72) to prevent memory leak.
        // Without this, the event handler OnPropertyChanged keeps a reference to this instance,
        // preventing garbage collection even after the ViewModel is no longer needed.
        PropertyChanged -= OnPropertyChanged;
